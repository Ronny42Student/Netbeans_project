...
<head>
    ...
    <style>
        body { background: url('${pageContext.request.contextPath}/assets/img/bkgrnd.jpg'); }
    </style>
</head>
<body class="flex items-center justify-center min-h-screen font-sans">
    ...
    <div class="w-full max-w-sm px-6">
        <div class="text-center mb-10">
            <h1 class="text-4xl font-light text-gray-800 tracking-widest"><strong>INSCRIPTION</strong></h1>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Déjà membre ? <a href="${pageContext.request.contextPath}/login" class="text-teal-500 hover:underline">Connectez-vous</a></p>
        </div>
    </div>
</body>
</html>